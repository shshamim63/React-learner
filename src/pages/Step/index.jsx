  ...
  return (
    <Container maxWidth="lg">
      ...
      <Typography
        ...
        paragraph
      >
        Update your progess as you move forward
      </Typography>
                  ...
                  <Grid container spacing={1} justifyContent="center">
                    <Grid item xs={4} sm={4} md={4}>
                      <Typography
                        ...
                        align="center"
                        backgroundColor={
                          stepNumber >= 1 ? "primary.dark" : "white"
                        }
                        width={35}
                        borderRadius={50}
                        margin="auto"
                    ...
                    <Grid item xs={4} sm={3} md={4}>
                      <Typography
                        ...
                        align="center"
                        backgroundColor={
                          stepNumber >= 2 ? "primary.dark" : "white"
                        }
                        width={35}
                        borderRadius={50}
                        margin="auto"
                    ...
                    <Grid item xs={4} sm={3} md={4}>
                      <Typography
                        ...
                        align="center"
                        backgroundColor={
                          stepNumber >= 3 ? "primary.dark" : "white"
                        }
                        width={35}
                        borderRadius={50}
                        margin="auto"
